...
.\vdexExtractor_winx86_64\vdexExtractor.exe -f -v 4 -i .\original\ANE\gnss_supl20service_hisi.vdex 

REM Genere les fichiers smali 
java -jar baksmali-2.5.2.jar deodex -a 26 -o .\supl20\ANE\src-out2 -b  ..\..\huawei-26\framework\arm64\boot.oat ".\original\ANE\gnss_supl20service_hisi.apk_classes.dex"
...
java -jar apktool_2.6.0.jar decode -f -o .\supl20\ANE\apk-out2 .\original\ANE\gnss_supl20service_hisi.apk
...
mkdir .\supl20\ANE\src-out2\com\android\altair\
xcopy /Y .\supl20-new\apk-out\smali\com\android\altair\CopyArrayMod.smali .\supl20\ANE\src-out2\com\android\altair\
...
FOR /R ".\supl20\ANE\src-out2" %%f IN (*.smali) DO  (
...
java -jar smali-2.5.2.jar a --api 26 .\supl20\ANE\src-out2 -o .\supl20\ANE\apk-out2\classes.dex

REM Recompile APK  dans le repertoire cible
java -jar apktool_2.6.0.jar build -o .\supl20\ANE\recompiled.apk  .\supl20\ANE\apk-out2

REM Sign this plateform signature
java -jar "ApkSigner.jar" sign  --key platform.pk8 --cert platform.x509.pem  --v4-signing-enabled false --out ".\supl20\ANE\gnss_supl20service_hisi_signed.apk" ".\supl20\ANE\recompiled.apk"

REM Recopie
del .\apk\gnss_supl20service_hisi.apk
REM xcopy /Y .\supl20\ANE\gnss_supl20service_hisi_signed.apk .\apk\gnss_supl20service_hisi.apk
zipalign -f -p -v 4 .\supl20\ANE\gnss_supl20service_hisi_signed.apk .\apk\gnss_supl20service_hisi.apk
